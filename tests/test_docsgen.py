...
def test_generated_docs_carry_the_instruction_on_the_field_not_the_setter():
    ...
    instruction = pagetype.field_spec(brief, "summary", "body").description
    ...
    assert pagetype.command(brief, "setSummary").description == "set the summary"
...
def test_generated_docs_do_not_repeat_the_instruction_under_every_setter():
    ...
    brief = get_page_type("feature-brief")
    first_line = pagetype.field_spec(brief, "summary", "body").description.splitlines()[0]
